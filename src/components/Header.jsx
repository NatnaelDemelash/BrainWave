    ...
    >
      <div className="flex items-center py-2 px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav
          ...
          } fixed top-[5rem] bottom-0 right-0 bg-n-8 left-0 lg:static lg:flex lg:mx-auto lg:bg-transparent`}
        >
        ...
        <a
          href="#signup"
          className="hidden lg:block mr-8 text-n-1/50 transition-colors hover:text-n-1"
        >
          New Account
        </a>
